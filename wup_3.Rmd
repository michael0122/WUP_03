...
using the tukey box plot we can tell that the front is different from the back and the middle is different from the back. however there is no difference between the back and the front.
